...
const translations = {
  en: {
    ...
    onb5Title: "Install the App 📱",
    onb5DescInstall: "One tap to add TripCore to your home screen. Launch it like any app!",
    onb5DescManual: "Tap Share in your browser → Add to Home Screen to install TripCore.",
    onb5InstallBtn: "Install Now",
    skip: "Skip",
    next: "Next",
    finish: "Finish",
  ...
  id: {
    ...
    howToSettleUp: "Siapa Bayar Siapa",
    owes: "bayar ke",
    ...
    onb5Title: "Pasang Appnya 📱",
    onb5DescInstall: "Satu tap buat pasang TripCore di homescreen. Buka appnya jadi lebih cepet!",
    onb5DescManual: "Tap Share di browser → Add to Home Screen buat pasang TripCore.",
    onb5InstallBtn: "Pasang Sekarang",
    skip: "Skip",
    next: "Lanjut",
    finish: "Selesai",
